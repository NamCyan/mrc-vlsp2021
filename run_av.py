...
from data_utils import get_examples, convert_examples_to_features, SquadResult
import pickle
...
from transformers import (WEIGHTS_NAME, 
                          RobertaConfig, PhobertTokenizer,
...
def main():
    ...
    args = get_args()
    args.output_dir = "../result/av_{}_{}_lr{}_len{}_bs{}_ep{}_wm{}".format(args.predict_file.split("/")[-1].replace(".json", ""), args.model_type, args.learning_rate, args.max_seq_length, args.per_gpu_train_batch_size, args.num_train_epochs, args.warmup_steps)
